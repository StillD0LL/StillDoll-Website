      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-2 cursor-pointer">
          <div className="w-8 h-8 bg-indigo-600 rounded-lg flex items-center justify-center">
            <span className="text-white font-bold text-xl leading-none tracking-tighter">M</span>
          </div>
          <span className="text-xl font-bold tracking-tight text-white hidden sm:block">Miruro</span>
        </div>
        
        <div className="hidden lg:flex items-center gap-1 ml-4">
          {['Home', 'Anime', 'Manga', 'Community'].map((item) => (
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        <div className="relative hidden md:block">
          ...
          <input 
            ...
            className="w-64 bg-zinc-900 border border-zinc-800 rounded-full py-1.5 pl-9 pr-4 text-sm text-zinc-200 focus:outline-none focus:border-indigo-500/50 focus:ring-1 focus:ring-indigo-500/50 placeholder:text-zinc-600 transition-all"
          />
        </div>
